    ...
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="40" height="40">
      ...
      <g id="SVGRepo_iconCarrier">
        <g data-name="Layer 3" id="Layer_3">
          ...
          <path fill="#795548" d="M24.06,3.49a.51.51,0,0,0-.55-.41l-2.1.27a.51.51,0,0,0-.35.22A.49.49,0,0,0,21,4,10.55,10.55,0,0,1,21.26,8a.91.91,0,0,1-.14.33.51.51,0,0,0-.07.43s0,0,0,0a1,1,0,0,0,.68.7.87.87,0,0,0,.25,0,1.09,1.09,0,0,0,.62-.21l.14-.09.08-.09a4.48,4.48,0,0,0,.39-.61A8.11,8.11,0,0,0,24.06,3.49Z"></path>
        </g>
      </g>
    </svg>
  )
